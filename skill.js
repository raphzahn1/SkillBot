...
module.exports = {
    getSkill: function(session,params,intent,req) {
        ...
        if(result[1] != undefined){
            if(params["skills"] != (undefined || "") && params["mitarbeiter"] == (undefined || "")){
                basiswort = result[1]["skills"]
                console.log(basiswort + "S")
              }else if(params["skills"] == (undefined || "") && params["mitarbeiter"] != (undefined || "")){
        ...
        console.log("Der Kontext aus Skill: "+JSON.stringify(req.body.queryResult.outputContexts))
    ...
    getSkillsFU: function (req,session,params){
      console.log("SkillFU")
        ...
        console.log("Parameter in SkillFU:" + JSON.stringify(fu) + context["skills"])
      ...
      // vorher muss der Artikel gesucht werden
        ...
        for (var key in fu){
                ...
                if(param == "level") {
                  fulfillmentText += context['mitarbeiter'] + " ist in "+context["skills"]+" auf dem Level *" +context['level']+"*."
                } 
                if(param == "beschreibung"){
                  message["fulfillmentMessages"]  = [
                         {
                          "card": {
                          "title": "Hier ist eine Beschreibung zu " + context["skills"]+ ": bitte klicken :sparkles:",
                              ...
                              "buttons": [
                                  {
                              "text": "button text",
                              "postback": "https://de.wikipedia.org/wiki/" + context["skills"]
                              }
                            ]
                          }
                        }
